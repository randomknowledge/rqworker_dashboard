...
SECRET_KEY = '_+i-jl02varihfcvk&amp;77ua(1sl+$z^8mygbw*!-!+^14j02^vn'
...
ROOT_URLCONF = 'RQWorkerDashboard.urls'
...
# See http://docs.djangoproject.com/en/dev/topics/logging for%(pathname)s
